...
/*
//(ticks how long to run for, optional filter.) eg (200,[creep.moveToModule])
Game.profiler.profile(ticks, [functionFilter]); //Default, Run profile
Game.profiler.stream(ticks, [functionFilter]); //stream output
Game.profiler.email(ticks, [functionFilter]); //run profile then email screeps profile
Game.profiler.background([functionFilter]); //run constant in background

// Output current background profile data.
